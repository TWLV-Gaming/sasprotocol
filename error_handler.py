...
##  Serves as a base class for all custom exceptions defined in this file. It inherits from Python's built-in Exception class, allowing it to be used as a standard exception.
