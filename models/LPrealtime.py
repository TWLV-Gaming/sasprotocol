class GPollrealtime:
    ...
    STATUS_MAP = {
        ...
        "31": ["R", "Send $1.00 bilss meter"],
        "32": ["R", "Send $2.00 bilss meter"],
        "33": ["R", "Send $5.00 bilss meter"],
        "34": ["R", "Send $10.00 bilss meter"],
        "35": ["R", "Send $20.00 bilss meter"],
        "36": ["R", "Send $50.00 bilss meter"],
        "37": ["R", "Send $100.00 bilss meter"],
        "38": ["R", "Send $500.00 bilss meter"],
        "39": ["R", "Send $1,000.00 bilss meter"],
        "3A": ["R", "Send $200.00 bilss meter"],
        "3B": ["R", "Send $25.00 bilss meter"],
        "3C": ["R", "Send $2,000.00 bilss meter"],
        "3D": ["R", "Send cash out ticket information"],
        "3E": ["R", "Send $2,500.00 bilss meter"],
        "3F": ["R", "Send $5,000.00 bilss meter"],
        "40": ["R", "Send $10,000.00 bilss meter"],
        "41": ["R", "Send $20,000.00 bilss meter"],
        "42": ["R", "Send $25,000.00 bilss meter"],
        "43": ["R", "Send $50,000.00 bilss meter"],
        "44": ["R", "Send $100,000.00 bilss meter"],
        "45": ["R", "Send $250.00 bilss meter"],
